...
class TableComponentTest extends TestCase
{
    ...
    /**
     * Отобразить (Horizontals границы)
     */
    public function testDisplayHorizontals(): void
    {
        $output = new ConsoleOutput(new Formatter());
        $output->setStream(new Stream('php://memory'));
        $tableStyle = new TableStyle();
        $tableStyle->setBorder('horizontals');
        $table = new TableComponent($output, $tableStyle);
    ...
    /**
     * Отобразить (Rounded границы)
     */
    public function testDisplayRounded(): void
    {
        $output = new ConsoleOutput(new Formatter());
        $output->setStream(new Stream('php://memory'));
        $tableStyle = new TableStyle();
        $tableStyle->setBorder('rounded');
        $table = new TableComponent($output, $tableStyle);
