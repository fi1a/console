...
use Fi1a\Console\Component\TableComponent\HeavyBorder;
use Fi1a\Console\Component\TableComponent\HeavyCompactBorder;
use Fi1a\Console\Component\TableComponent\HorizontalsBorder;
use Fi1a\Console\Component\TableComponent\NoneBorder;
use Fi1a\Console\Component\TableComponent\RoundedBorder;
...
BorderRegistry::add('heavy_compact', new HeavyCompactBorder());
BorderRegistry::add('horizontals', new HorizontalsBorder());
BorderRegistry::add('rounded', new RoundedBorder());
BorderRegistry::add('rounded_compact', new RoundedCompactBorder());
